...
//         await axiosClient.get(apiEndpoints.mediaList({ mediaType, mediaCategory, page })),
...
//         await axiosClient.get(apiEndpoints.mediaCredits({ mediaType, mediaId })),
//     mediaVideos: async ({ mediaType, mediaId }) =>
//         await axiosClient.get(apiEndpoints.mediaVideos({ mediaType, mediaId })),
//     mediaImages: async ({ mediaType, mediaId }) =>
//         await axiosClient.get(apiEndpoints.mediaImages({ mediaType, mediaId })),
//     mediaRecommend: async ({ mediaType, mediaId }) =>
//         await axiosClient.get(apiEndpoints.mediaRecommend({ mediaType, mediaId })),
//     mediaSearch: async ({ mediaType, query, page }) =>
//         await axiosClient.get(apiEndpoints.mediaSearch({ mediaType, query, page })),
