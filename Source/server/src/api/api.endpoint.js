...
//     mediaDetail: ({ mediaType, mediaId }) => apiConfig.getUrl(`${mediaType}/${mediaId}`),
//     mediaGenres: ({ mediaType }) => apiConfig.getUrl(`genre/${mediaType}/list`),
//     mediaVideos: ({ mediaType, mediaId }) => apiConfig.getUrl(`${mediaType}/${mediaId}/videos`),
//     mediaRecommend: ({ mediaType, mediaId }) => apiConfig.getUrl(`${mediaType}/${mediaId}/recommendations`),
